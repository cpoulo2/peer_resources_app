...
# Sidebar - Create a sidebar that filt

# Create header.title with space to add formating using markdown
...
st.markdown('<h1 class="header-title">Explore Your District\'s Resources</h1>', unsafe_allow_html=True)
